...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[CSV_SOURYOU_ver1]') AND type in (N'U'))
DROP TABLE [dbo].[CSV_SOURYOU_ver1]
GO
...
CREATE TABLE [dbo].[CSV_SOURYOU_ver1](
 ...
 CONSTRAINT [PK_CSV_SOURYOU_ver1] PRIMARY KEY CLUSTERED 
(
	[CSO_KCD] ASC,
	[CSO_TENCD] ASC,
	[CSO_TEKIYOYMD] ASC,
