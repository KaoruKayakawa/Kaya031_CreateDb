...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[TYUMON_KNR_MST_old]') AND type in (N'U'))
DROP TABLE [dbo].[TYUMON_KNR_MST_old]
GO
...
CREATE TABLE [dbo].[TYUMON_KNR_MST_old](
 ...
 CONSTRAINT [PK_TYUMON_KNR_MST_old] PRIMARY KEY CLUSTERED 
(
	[STKF_KCD] ASC,
	[STKF_HTCD] ASC,
	[STKF_SCD] ASC,
