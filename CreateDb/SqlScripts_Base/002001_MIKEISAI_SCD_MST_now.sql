...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MIKEISAI_SCD_MST_now]') AND type in (N'U'))
DROP TABLE [dbo].[MIKEISAI_SCD_MST_now]
GO
...
CREATE TABLE [dbo].[MIKEISAI_SCD_MST_now](
 ...
 CONSTRAINT [PK_MIKEISAI_SCD_MST_now] PRIMARY KEY CLUSTERED 
(
	[MKS_KCD] ASC,
	[MKS_HTCD] ASC,
	[MKS_SCD] ASC,
