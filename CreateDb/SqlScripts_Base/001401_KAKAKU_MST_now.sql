...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[KAKAKU_MST_now]') AND type in (N'U'))
DROP TABLE [dbo].[KAKAKU_MST_now]
GO
...
CREATE TABLE [dbo].[KAKAKU_MST_now](
 ...
 CONSTRAINT [PK_KAKAKU_MST_now] PRIMARY KEY CLUSTERED 
(
	[SKAK_KCD] ASC,
	[SKAK_HTCD] ASC,
	[SKAK_SCD] ASC,
