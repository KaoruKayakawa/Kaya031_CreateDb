	...
	BEGIN TRY
		...
		WITH
			...
			t2 AS (
				...
				INNER JOIN t1
				ON a.SKAK_KCD = t1.SKAK_KCD
					AND a.SKAK_HTCD = t1.SKAK_HTCD
					AND a.SKAK_SCD = t1.SKAK_SCD
					AND a.SKAK_KIKAKUCD = t1.SKAK_KIKAKUCD
				LEFT OUTER JOIN #wt_UPDATE_WITH_KAKAKU_MST_101 b
