...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GET_SHOHIN_M_INFO_ALLPERIOD]') AND type in (N'IF'))
DROP FUNCTION [dbo].[GET_SHOHIN_M_INFO_ALLPERIOD]
GO
...
-- =============================================
CREATE FUNCTION [dbo].[GET_SHOHIN_M_INFO_ALLPERIOD]
(	
