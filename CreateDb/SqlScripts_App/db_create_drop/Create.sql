...
CREATE DATABASE [#{-APP_DB-}#]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'#{-APP_DB-}#', FILENAME = N'#{-APP_DB_FOLDER_PATH-}#\#{-APP_DB-}#.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'#{-APP_DB-}#_log', FILENAME = N'#{-APP_DB_FOLDER_PATH-}#\#{-APP_DB-}#_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [#{-APP_DB-}#] SET TRUSTWORTHY ON 
GO
...
ALTER DATABASE [#{-APP_DB-}#] SET RECOVERY FULL 
GO
...
ALTER DATABASE [#{-APP_DB-}#] SET QUERY_STORE = OFF
GO
